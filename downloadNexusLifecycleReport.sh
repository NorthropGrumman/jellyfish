...
echo "Downloading Nexus Lifecycle PDF report '$BUILD_ID'"

curl -L -k -u 'JustanLProvence:Passw)rd' "${SEARCH_STRING}${BUILD_ID}/pdf" > $OUTPUT_DIRECTORY/Nexus-Lifecycle-Report-$BUILD_ID.pdf
