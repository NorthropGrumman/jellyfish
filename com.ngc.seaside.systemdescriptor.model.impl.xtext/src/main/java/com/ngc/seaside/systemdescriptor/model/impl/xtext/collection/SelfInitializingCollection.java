 ...
 */
public class SelfInitializingCollection<X extends EObject, T> extends AutoWrappingCollection<X, T> {
   ...
   */
  public SelfInitializingCollection(Function<X, T> wrapperFunction,
