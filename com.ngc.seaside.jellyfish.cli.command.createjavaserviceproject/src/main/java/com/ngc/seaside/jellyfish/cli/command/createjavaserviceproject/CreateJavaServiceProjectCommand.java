...
public class CreateJavaServiceProjectCommand implements IJellyFishCommand {
   ...
   private static IUsage createUsage() {
      // TODO Auto-generated method stub
      return new DefaultUsage("Description of create-java-service-project command", 
         new DefaultParameter<String>(EXAMPLE_PROPERTY).setDescription("Description of example property").setRequired(false));
   }
