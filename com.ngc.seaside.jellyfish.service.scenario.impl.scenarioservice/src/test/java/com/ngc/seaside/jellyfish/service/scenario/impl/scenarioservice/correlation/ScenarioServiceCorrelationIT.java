...
public class ScenarioServiceCorrelationIT {
   ...
   public void testMultipleExpressions() {
      ...
      ICorrelationExpression completion1 = completions.stream().filter(c -> c.getLeftHandOperand().getEnd().getName().equals("field1")).findAny().get();
      ICorrelationExpression completion2 = completions.stream().filter(c -> c.getLeftHandOperand().getEnd().getName().equals("field2")).findAny().get();
      ICorrelationExpression completion3 = completions.stream().filter(c -> c.getLeftHandOperand().getEnd().getName().equals("field3")).findAny().get();
      verifyCorrelation(completion1, DataTypes.INT, null, data1.getFields().getByName("field1").get(), data2.getFields().getByName("field1").get());
      verifyCorrelation(completion2, DataTypes.ENUM, enum1, data1.getFields().getByName("field2").get(), data3.getFields().getByName("field2").get());
      verifyCorrelation(completion3, DataTypes.BOOLEAN, null, data2.getFields().getByName("field3").get(), data3.getFields().getByName("field3").get());
      
      Collection<ICorrelationExpression> completions1 = description.getCompletenessExpressionForInput(model.getInputs().getByName("input1").get());
      assertEquals(2, completions1.size());
      ICorrelationExpression completion1_1 = completions1.stream().filter(c -> c.getLeftHandOperand().getEnd().getName().equals("field1")).findAny().get();
      ICorrelationExpression completion1_2 = completions1.stream().filter(c -> c.getLeftHandOperand().getEnd().getName().equals("field2")).findAny().get();
      verifyCorrelation(completion1_1, DataTypes.INT, null, data1.getFields().getByName("field1").get(), data2.getFields().getByName("field1").get());
      verifyCorrelation(completion1_2, DataTypes.ENUM, enum1, data1.getFields().getByName("field2").get(), data3.getFields().getByName("field2").get());
      
      Collection<ICorrelationExpression> completions2 = description.getCompletenessExpressionForInput(model.getInputs().getByName("input2").get());
      assertEquals(2, completions2.size());
      ICorrelationExpression completion2_1 = completions2.stream().filter(c -> c.getLeftHandOperand().getEnd().getName().equals("field1")).findAny().get();
      ICorrelationExpression completion2_2 = completions2.stream().filter(c -> c.getLeftHandOperand().getEnd().getName().equals("field3")).findAny().get();
      verifyCorrelation(completion2_1, DataTypes.INT, null, data1.getFields().getByName("field1").get(), data2.getFields().getByName("field1").get());
      verifyCorrelation(completion2_2, DataTypes.BOOLEAN, null, data2.getFields().getByName("field3").get(), data3.getFields().getByName("field3").get());
      
      Collection<ICorrelationExpression> completions3 = description.getCompletenessExpressionForInput(model.getInputs().getByName("input3").get());
      assertEquals(2, completions2.size());
      ICorrelationExpression completion3_1 = completions3.stream().filter(c -> c.getLeftHandOperand().getEnd().getName().equals("field2")).findAny().get();
      ICorrelationExpression completion3_2 = completions3.stream().filter(c -> c.getLeftHandOperand().getEnd().getName().equals("field3")).findAny().get();
      verifyCorrelation(completion3_1, DataTypes.ENUM, enum1, data1.getFields().getByName("field2").get(), data3.getFields().getByName("field2").get());
      verifyCorrelation(completion3_2, DataTypes.BOOLEAN, null, data2.getFields().getByName("field3").get(), data3.getFields().getByName("field3").get());
      
      Collection<ICorrelationExpression> correlations = description.getCorrelationExpressions();
      assertEquals(3, correlations.size());
      ICorrelationExpression correlation1 = correlations.stream().filter(c -> c.getLeftHandOperand().getEnd().getName().equals("field1")).findAny().get();
      ICorrelationExpression correlation2 = correlations.stream().filter(c -> c.getLeftHandOperand().getEnd().getName().equals("field2")).findAny().get();
      ICorrelationExpression correlation3 = correlations.stream().filter(c -> c.getLeftHandOperand().getEnd().getName().equals("field3")).findAny().get();
      verifyCorrelation(correlation1, DataTypes.INT, null, data1.getFields().getByName("field1").get(), data4.getFields().getByName("field1").get());
      verifyCorrelation(correlation2, DataTypes.ENUM, enum1, data1.getFields().getByName("field2").get(), data5.getFields().getByName("field2").get());
      verifyCorrelation(correlation3, DataTypes.BOOLEAN, null, data2.getFields().getByName("field3").get(), data6.getFields().getByName("field3").get());

      Collection<ICorrelationExpression> correlations1 = description.getCorrelationExpressionForOutput(model.getOutputs().getByName("output1").get());
      assertEquals(1, correlations1.size());
      ICorrelationExpression correlation1_1 = correlations1.iterator().next();
      verifyCorrelation(correlation1_1, DataTypes.INT, null, data1.getFields().getByName("field1").get(), data4.getFields().getByName("field1").get());
      
      Collection<ICorrelationExpression> correlations2 = description.getCorrelationExpressionForOutput(model.getOutputs().getByName("output2").get());
      assertEquals(1, correlations2.size());
      ICorrelationExpression correlation2_1 = correlations2.iterator().next();
      verifyCorrelation(correlation2_1, DataTypes.ENUM, enum1, data1.getFields().getByName("field2").get(), data5.getFields().getByName("field2").get());
      
      Collection<ICorrelationExpression> correlations3 = description.getCorrelationExpressionForOutput(model.getOutputs().getByName("output3").get());
      assertEquals(1, correlations3.size());
      ICorrelationExpression correlation3_1 = correlations3.iterator().next();
      verifyCorrelation(correlation3_1, DataTypes.BOOLEAN, null, data2.getFields().getByName("field3").get(), data6.getFields().getByName("field3").get());
   ...
   public void testWithSource() {
      ...
      verifyCorrelation(correlation, DataTypes.INT, null, data1.getFields().getByName("field1").get(), data2.getFields().getByName("field1").get());
      
   }
   
   private static void verifyCorrelation(ICorrelationExpression correlation, DataTypes expectedType,
            INamedChild<IPackage> expectedChild, IDataField expectedLeft, IDataField expectedRight) {
