...
public class HelpCommandTests
{
   ...
   private IUsage mockUsage1 = new DefaultUsage("Usage 1", new DefaultParameter("param1", "Description 1.1", true),
      new DefaultParameter("param2", "Description 2.1", true),
      new DefaultParameter("param3", "Description 3.1", false),
      new DefaultParameter("param4", "Description 4.1", false));
   
   private IUsage mockUsage2 = new DefaultUsage("Usage 2 ja;skldg jasd g;kjsgd ;jasd gklj", new DefaultParameter("param1asdgasdgawe", "Description 1.2 asdjf iosdj f;klsjad f;jklasd f;klasjg a;weijaweio gj", true),
      ...
      new DefaultParameter("param3", "Description 3.2 ajga;s kdj;kljsd ga;klsjdg ;klj sg", false),
      new DefaultParameter("param4", false));

   private IJellyFishCommand mockCmd2 = Mockito.mock(IJellyFishCommand.class);
