...
public class CreateJavaDistributionCommand implements IJellyFishCommand {
   ...
   private static IUsage createUsage() {
      // TODO Auto-generated method stub
      return new DefaultUsage("Description of create-java-distribution command", new DefaultParameter(EXAMPLE_PROPERTY).setDescription("Description of example property").setRequired(false));
   }
