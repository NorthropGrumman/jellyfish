package com.ngc.example.models.modelservice.tests.main;

import com.ngc.example.models.modelservice.tests.steps.ModelServiceSteps;

import java.nio.file.Path;
import java.nio.file.Paths;

/**
 * This application runs the {@link ModelServiceSteps}.
 */
public class ModelServiceTestMain {
   ...
   public static void main(String[] args) throws Throwable {
      ...
      if (args.length == 0) {
         ...
         if (folder != null) {
            ...
            args = new String[] {
              "--glue", ModelServiceSteps.class.getPackage().getName(),
              "--plugin", "pretty",
