...
import com.ngc.seaside.threateval.tps.tests.di.TrackPriorityServiceTestModule;
import com.ngc.seaside.threateval.tps.tests.steps.TrackPriorityServiceSteps;
import com.ngc.seaside.threateval.tps.testsconfig.TrackPriorityServiceTestConfigurationModule;
   ...
   public static void main(String[] args) throws Throwable {
      ...
      try {
         returnStatus = CucumberRunnerBuilder.withAppHomeFromSystemProperty(APP_HOME_SYS_PROPERTY, "build/runtime")
            ...
            .setStepPackage(TrackPriorityServiceSteps.class.getPackage())
            ...
            .addModules(new LogServiceModule(),
                        ...
                        new LoggingFaultManagementServiceModule(),
                        new TrackPriorityServiceTestConfigurationModule(),
