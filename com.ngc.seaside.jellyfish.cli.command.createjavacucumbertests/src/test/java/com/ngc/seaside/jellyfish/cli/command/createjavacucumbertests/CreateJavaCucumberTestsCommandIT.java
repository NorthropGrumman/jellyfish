...
public class CreateJavaCucumberTestsCommandIT {
   ...
   private CreateJavaCucumberTestsCommand cmd = new CreateJavaCucumberTestsCommand();
   ...
   public void setup() throws IOException {
      ...
      MockedTemplateService mockedTemplateService = new MockedTemplateService()
            ...
            .setTemplateDirectory(CreateJavaCucumberTestsCommand.class.getPackage().getName(),
