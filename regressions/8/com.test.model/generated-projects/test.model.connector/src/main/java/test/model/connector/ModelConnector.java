...
public class ModelConnector {
   ...
   private void postReceiveMessage(test.model.transport.topic.ModelTransportTopics transportTopic) {
      RequestThreadLocal.clear();
   }

   private void preSendMessage(test.model.transport.topic.ModelTransportTopics transportTopic) {
      // Do nothing.
   }
   ...
   private static Collection<String> getRequirementsForTransportTopic(ITransportTopic transportTopic) {
      ...
      switch((test.model.transport.topic.ModelTransportTopics) transportTopic){
         default:
