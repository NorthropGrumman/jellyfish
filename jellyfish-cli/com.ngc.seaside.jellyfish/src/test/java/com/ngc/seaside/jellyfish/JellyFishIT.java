...
@Ignore("This test is hanging right now due to the SD project not being installed.  Need to figure this out.  "
        + "Its string to download the system descriptor files for the Jellyfish project which doesn't exist.")
public class JellyFishIT {
   ...
   public void before() throws Throwable {
      ...
      String ngFwHome =
            Paths.get(System.getProperty("user.dir"), "build", "resources", "test").toAbsolutePath().toString();
