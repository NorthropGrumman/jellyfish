...
/**
 * Represents a type of finding for a System Descriptor project. A finding could represent an error or warning found in
 * the project, or it could simply document information about the System Descriptor project itself. Actual findings
 * are created using {@link #createFinding}.
 */
public interface ISystemDescriptorFindingType {
    ...
    * @param location the source code {@link SystemDescriptorFinding#getLocation() location} of the finding, may be null
    * @param complexity the {@link SystemDescriptorFinding#getComplexity() complexity} of the finding
    * @return a finding for this type
    */
   default SystemDescriptorFinding<ISystemDescriptorFindingType> createFinding(String message, ISourceLocation location,
            double complexity) {
