 ...
 * <p/>
 * Commands also use this service to {@link #registerProject(IJellyFishCommandOptions, IProjectInformation) register
...
public interface IBuildManagementService {
   ...
   /**
    * Gets all projects that have been registered via {@link #registerProject(IJellyFishCommandOptions,
    * IProjectInformation)}.
    *
    ...
    */
   void registerProject(IJellyFishCommandOptions options, IProjectInformation project);
}
