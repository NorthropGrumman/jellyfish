...
public class CommonConfigurationUtils {
   static final String NETWORK_INTERFACE_QUALIFIED_NAME = "com.ngc.seaside.systemdescriptor.deployment.NetworkInterface";
   ...
   static NetworkInterface getNetworkInterface(IPropertyDataValue value) {
      if (!Objects.equals(NETWORK_INTERFACE_QUALIFIED_NAME, value.getReferencedDataType().getFullyQualifiedName())) {
         throw new IllegalArgumentException("Property " + value + " is not of type " + NETWORK_INTERFACE_QUALIFIED_NAME);
      }
