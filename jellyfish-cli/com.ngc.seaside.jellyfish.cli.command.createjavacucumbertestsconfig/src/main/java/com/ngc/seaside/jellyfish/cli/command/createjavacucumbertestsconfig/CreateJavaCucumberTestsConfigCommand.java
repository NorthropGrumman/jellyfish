...
public class CreateJavaCucumberTestsConfigCommand extends AbstractJellyfishCommand implements IJellyFishCommand {

   private static final String NAME = "create-java-cucumber-tests-config";

   public static final String EXAMPLE_PROPERTY = "example";

   public CreateJavaCucumberTestsConfigCommand() {
      super(NAME);
   }
