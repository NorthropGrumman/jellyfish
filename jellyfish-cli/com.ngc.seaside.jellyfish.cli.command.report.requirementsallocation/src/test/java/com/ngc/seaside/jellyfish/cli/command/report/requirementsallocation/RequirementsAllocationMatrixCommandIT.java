...
public class RequirementsAllocationMatrixCommandIT {
   ...
   public void setup() throws IOException {
      ...
      IModel[] models = {
               ...
               new ModelBuilder("com.ngc.seaside.ModelReqsInMetadata", "model", "service", "virtual").requirements(Section.MODEL, "REQ001", "REQ002").build(),
               new ModelBuilder("com.ngc.seaside.ModelReqsInMetadataOfInputField", "model", "service",  "virtual", "input").requirements(Section.INPUT, "REQ002", "REQ003").build(),
               new ModelBuilder("com.ngc.seaside.ModelReqsInMetadataOfOutputField", "model", "service", "virtual", "output").requirements(Section.OUTPUT, "REQ001", "REQ003", "REQ004").build(),
               new ModelBuilder("com.ngc.seaside.ModelReqsInMetadataOfPartsField", "model", "service").requirements(Section.PART, "REQ002", "REQ004", "REQ006").build(),
               new ModelBuilder("com.ngc.seaside.ModelReqsInMetadataOfScenario", "model", "virtual").requirements(Section.SCENARIO, "REQ001", "REQ003", "REQ007").build(),
      };
