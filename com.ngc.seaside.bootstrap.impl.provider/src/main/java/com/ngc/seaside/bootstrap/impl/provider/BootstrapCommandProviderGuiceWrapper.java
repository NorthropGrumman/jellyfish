...
public class BootstrapCommandProviderGuiceWrapper implements IBootstrapCommandProvider {
	...
	@Inject
	public BootstrapCommandProviderGuiceWrapper(ILogService logService, ITemplateService templateService,
			IParameterService parameterService, Set<IBootstrapCommand> commands) {
