...
public class Data implements IData {
	...
	public boolean equals(Object o) {
		...
		Data data = (Data) o;
		return Objects.equals(fields, data.fields) && Objects.equals(name, data.name) && parent == data.parent
	...
	public String toString() {
		return "Data[" + "fields=" + fields + ", name='" + name + '\'' + ", parent="
				+ (parent == null ? "null" : parent.getName()) + ", metadata=" + metadata + ']';
	}
}
